...
| ✅ Search & Filtering | Пошук за ключовим словом, тегом, мінімальним рейтингом, діапазоном дат (`date_from` / `date_to`), сортування |
...
| ✅ Unit & Integration Tests | 187 тестів, покриття коду 93.5% |
...
Проєкт містить **187** unit та integration тести з **ізольованою тестовою БД** (очищення таблиць перед кожним тестом). Cloudinary та QR-сервіси **мокуються** — реальні зовнішні виклики не виконуються.
...
- [x] ✅ Фільтр за діапазоном дат (`date_from` / `date_to`)
...
- [x] ✅ Unit та integration тести (187 тести, 93.5% coverage)
